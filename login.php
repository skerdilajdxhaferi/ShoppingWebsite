...
$query=mysqli_query($con,"insert into users(name,email,contactno, address, state, city, password) values('$name','$email','$contactno', '$address', '$state', '$city', '$password')");
if($query)
{
	echo "<script>alert('You are successfully registered.');</script>";
}
else{
echo "<script>alert('Not registered, something went wrong!Please try again!');</script>";
}
}
// Code for User login
...
<html lang="en">
	<head>
	    ...
	    <title>Shopping Portal | Sign in | Sign up</title>
...
<div class="form-group">
	...
	<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="state" name="state"  required >
	  	</div>
			<div class="form-group">
	    	<label class="info-title" for="city"> City <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" id="city" name="city"   required >
	  	</div>
